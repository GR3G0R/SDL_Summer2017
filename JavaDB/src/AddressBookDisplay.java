// File Name: AddressBookDisplay.java 2
...
public class AddressBookDisplay extends JFrame
{
    ...
    public AddressBookDisplay()
    {
        ...
        queryPanel.setBorder(BorderFactory.createTitledBorder(
                "Find an entry by last name or state"));
        ...
        queryPanel.add(Box.createHorizontalStrut(5));
        queryPanel.add(stateQueryLabel);
        queryPanel.add(Box.createHorizontalStrut(10));
        queryPanel.add(stateQueryTextField);
        queryPanel.add(Box.createHorizontalStrut(10));
        stateQueryButton.setText("Find");
        stateQueryButton.addActionListener(
        		new ActionListener()
        		{
        			public void actionPerformed(ActionEvent evt)
        			{
        ...
        queryPanel.add(stateQueryButton);
        queryPanel.add(Box.createHorizontalStrut(5));
    ...
    {
        results =
                personQueries.getPeopleByState(stateQueryTextField.getText());
        numberOfEntries = results.size();
    ...
    {
       personQueries.deletePerson(idTextField.getText());
    }

    // handles call when updateButton is clicked
    private void updateButtonActionPerformed(ActionEvent evt)
    {
    	personQueries.updatePerson(firstNameTextField.getText(),
    			lastNameTextField.getText(), emailTextField.getText(),
    			phoneTextField.getText(),stateTextField.getText(),
    			idTextField.getText());
    }
